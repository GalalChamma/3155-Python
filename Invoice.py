class Invoice:
    ...
    def totalPurePriceWithTax(self, products):  # Function that adds the tax to the pure price
        total_pure_price_with_tax = self.totalPurePrice(products) + self.totalSalesTax(products)
        return total_pure_price_with_tax  # Return total price after adding tax
